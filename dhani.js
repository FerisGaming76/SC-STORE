...
success: 'Sukses ✅️',
error: {
stick: aaf ini bukan stiker !!',
Iv: 'Link invalid !!'
},
only: {
group: 'Fitur hanya bisa di gunakan di dalam group !!',
owner: 'Fitur hanya bisa digunakan oleh owner botz !!',
admin: 'Fitur ini hanya bisa digunakan oleh admin group !!',
Badmin: 'Jadikan admin groun jika ingin menggunakan fitur ini !!'
}
}
...
//══════════[ Fake ]══════════//
        ...
        const listmsg = (from, title, desc, list) => { // ngeread nya pake rowsId, jadi command nya ga keliatan
            let po = Dhani.prepareMessageFromContent(from, {"listMessage": {"title": title,"description": desc,"buttonText": "MENU","footerText": `${tanggal}`,"listType": "SINGLE_SELECT","sections": list}}, {})
...
teks =
`「 ${botname} 」\n*${tanggal}*`
Dhani.sendMessage(from, { contentText: `${menu}`, footerText: `${teks}`, buttons: [{ buttonId: `${prefix}store`, buttonText: { displayText: 'STORE' }, type: 1 },{ buttonId: `${prefix}owner`, buttonText: { displayText: 'location' }, type: 1 } ], headerType: 'LOCATION', locationMessage: { degreesLatitude: '', degreesLongitude: '', jpegThumbnail: fakeimage, contextInfo: {mentionedJid: [sender]}}}, 'buttonsMessage')
break
...
case 'store':
               ...
               listmenuu = [`MASUKAN DATA`,`DIAMOND FREE FIRE`,`DIAMOND MOBILE LEGEND`,`UC PUBG`,`CALL OF DUTTY`,`SAUSAGE MAN`,`JASA SHARE`,`PAYMENT`]
               nombor = 1
               startnum = 0
